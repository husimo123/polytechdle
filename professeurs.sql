...
('Lhommeau', 'Mehdi', 1, 49, 'SAGI', 'Nantes', 2003, 'Professeur / HDR', 'Etude de systèmes à événements discrets dans l algèbre (max,+)', 'https://perso-laris.univ-angers.fr/~lhommeau/photo2.jpg'),
('Hardouin', 'Laurent', 1, 57, 'SAGI', 'Poitiers', 1993, 'HDR', 'Une méthode originale de contrôle actif des bruits d’écoulements pulsés : Étude d’un actionneur modélisation et commande adaptative du système', 'http://perso-laris.univ-angers.fr/~hardouin/LaurentHardouin.jpg'),
...
('Perez', 'Laetitia', 1, 0, 'SAGI', 'Paris', 2003, 'Maître de Conférences / HDR', 'Développement, étude de performances et intégration de sondes thermiques pour la caractérisation de l encrassement d échangeurs tubulaires à courants croisés', 'https://tse2.mm.bing.net/th?id=OIP.0sF-fFXTbAkGzG8LC0Z18QHaHa&pid=Api'),
...
('Declerck', 'Philippe', 1, 0, 'SAGI', 'Lille', 1991, 'Maître de Conférences / HDR', 'Analyse structurale et fonctionnelle des grands systèmes : applications à une centrale PWR 900 MW', "http://perso-laris.univ-angers.fr/~declerck/Philippe%2005-01-07''.jpg"),
...
('Lahaye', 'Sébastien', 1, 51, 'SAGI', 'Angers', 2018, 'Professeur', 'Comprendre les grands feux de forêt pour lutter en sécurité', 'http://perso-laris.univ-angers.fr/~lahaye/IdentiteWeb.png'),
('Daviaud', 'Bérangère', 1, 0, 'SAGI', 'Angers', 2024, 'Attaché Temporaire à l’Enseignement et à la Recherche', 'Méthodes formelles pour les systèmes réactifs, applications au live coding', 'https://laris.univ-angers.fr/_resource/Photos/daviaud_rond.png'),
('Guegnard', 'Frédéric', 1, 0, 'SAGI', 'Angers', 2000, 'Maître de Conférences', 'Caractérisation polynomiale des processus séquentiels', 'https://laris.univ-angers.fr/_resource/guegnard_rond.jpg'),
('Lagrange', 'Sébastien', 1, 0, 'PEIP/SAGI', 'Nantes', 2005, 'Maître de Conférences', 'Contributions aux méthodes d’estimation en aveugle.', 'http://perso-laris.univ-angers.fr/~lagrange/images/seb.jpg');
COMMIT;
